...
export function Stats(_props: StatsProps) {
  ...
  return (
    <div className='border-border bg-muted/30 relative z-10 border-y'>
      <div className='mx-auto max-w-6xl px-6 py-16 md:py-20'>
        <div className='grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-12'>
          {stats.map((s) => (
            ...
            >
              <span className='home-gradient-text font-mono text-3xl font-bold tracking-tight md:text-4xl'>
