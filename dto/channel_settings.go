...
type ClaudeInputBillingMode string

const (
	ClaudeInputBillingModeUpstream           ClaudeInputBillingMode = "upstream"
	ClaudeInputBillingModeLocalEstimateAudit ClaudeInputBillingMode = "local_estimate_audit"
...
type ChannelOtherSettings struct {
	...
	AnthropicDirectPassthroughEnabled     bool                   `json:"anthropic_direct_passthrough_enabled,omitempty"` // Anthropic 渠道将 Messages 和兼容 Chat 请求原样转发到同路径上游
